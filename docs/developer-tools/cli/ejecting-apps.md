...
- [Converting to a Standalone App Package](#converting-to-a-standalone-app-package)
- [Should I Eject My App?](#should-i-eject-my-app)
- [Post-Eject Development Environment](#post-eject-development-environment)
