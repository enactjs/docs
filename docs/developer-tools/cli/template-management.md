...
- [Enact CLI Template Support](#enact-cli-template-support)
- [`install` vs `link`](#install-vs-link)
...
## Developing Templates
Read about [developing an Enact CLI template](../developing-a-template/) if you're intested in creating your own.
