...
- [Packaging Source Code](#packaging-source-code)
- [Production Mode](#production-mode)
- [Browser Support & Polyfills](#browser-support--polyfills)
- [\_\_DEV\_\_ Keyword](#__dev__-keyword)
...
- [Custom Skin Support](#custom-skin-support)
- [Build without Effects](#build-without-effects)
- [Caching](#caching)
- [Isomorphic Support & Prerendering](#isomorphic-support--prerendering)
- [V8 Snapshot Generation](#v8-snapshot-generation)
- [Watcher Option](#watcher-option)
...
## Watcher Option
Similar to the [`enact serve`](../serving-apps/) command, the watcher will build the project and wait for any detected source code changes. When a change is detected, it will rebuild the project. The rebuild time will be significantly faster since the process can actively cache and build only what has changed.
...
## Override Metadata
The @enact/cli tool inspects the `enact` object in the project's package.json for [customization options](../starting-a-new-app/#enact-project-settings). 
