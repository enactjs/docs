...
github: https://github.com/enactjs/enact/blob/develop/docs/migration/enact/migrating-to-enact-4.5.md
toc: 2
---
...
are coming from Enact 3.x, please [migrate to 4.0](../migrating-to-enact-4/) and then consult
this guide.
