...
github: https://github.com/enactjs/enact/blob/develop/docs/migration/enact/migrating-to-enact-3.md
toc: 2
---
...
are coming from Enact 1.x, please [migrate to 2.0](../migrating-to-enact-2/) and then consult
this guide.
