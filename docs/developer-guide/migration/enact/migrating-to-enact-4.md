...
github: https://github.com/enactjs/enact/blob/develop/docs\migration\enact\migrating-to-enact-4.md
toc: 2
---
...
are coming from Enact 2.x, please [migrate to 3.0](../migrating-to-enact-3/) and then consult
this guide.
