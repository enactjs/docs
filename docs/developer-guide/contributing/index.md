...
<!-- *   [Coding Style Guide](./code-style/) - The Enact code style explained -->
*   [Building Enact Locally](./building-enact-locally/) - How to install and use the Enact source
*   [Adding Automated UI Tests](./adding-automated-ui-tests/) - How to add and run the automated UI tests of Enact components
...
*   **IMPORTANT**: No pull requests will be accepted until the contributor has signed off on our ***[Enact Developer's Certificate of Origin v1.0](./dco/)***. We use an automated system that validates compliance before the first pull request is accepted.
...
*   Finally, a couple of practical matters to help our Pull Masters stay sane:
	...
	*   Ensure all new features have [unit tests](../testing-components/unit-testing/) that pass and any bug fixes include tests that fail without the fix applied. [Adding automated UI tests](./adding-automated-ui-tests/) supported by Enact packages are highly recommended.
