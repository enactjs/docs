...
github: https://github.com/enactjs/sandstone/blob/develop/docs/virtual-list-scroller.md
---
<nav role="navigation" class="page-toc">

- [VirtualList/VirtualGridList](#virtuallistvirtualgridlist)
- [Scroller](#scroller)
- [Using `scrollTo()` method in VirtualList/VirtualGridList and Scroller](#using-scrollto-method-in-virtuallistvirtualgridlist-and-scroller)
- [Event Callbacks for VirtualList/VirtualGridList and Scroller](#event-callbacks-for-virtuallistvirtualgridlist-and-scroller)
