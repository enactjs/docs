...
describe('VirtualList', function () {
  ...
  describe('ScrollTo', function () {
    ...
    test('should scroll to make the specific item of a given index stick to \'start\' position with scrollTo', function (done) {
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = 900;
        var actual = resultScrollTop;
        expect(actual).toBe(expected);
    ...
    test('should scroll to make the specific item of a given index stick to \'center\' position with scrollTo', function (done) {
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = 555;
        var actual = resultScrollTop;
        expect(actual).toBe(expected);
    ...
    test('should scroll to make the specific item of a given index stick to \'end\' position with scrollTo', function (done) {
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = 210;
        var actual = resultScrollTop;
        expect(actual).toBe(expected);
