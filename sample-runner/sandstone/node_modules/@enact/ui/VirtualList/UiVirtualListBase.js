    ...
    _createClass(VirtualListCore, [{
      ...
      value: function scrollToPosition(x, y) {
        ...
        if (this.containerRef.current) {
          ...
          if (rtl) {
            x = _platform.platform.chrome < 85 ? this.scrollBounds.maxLeft - x : -x;
          }
 ...
 */
var VirtualListBase = exports.UiVirtualListBase = VirtualListBaseFactory(JS);
 ...
 * @private
 */
var VirtualListBaseNative = exports.UiVirtualListBaseNative = VirtualListBaseFactory(Native);
