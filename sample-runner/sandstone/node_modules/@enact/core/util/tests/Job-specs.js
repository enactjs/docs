...
describe('Job', function () {
  ...
  describe('#stop', function () {
    ...
    test('should stop requestAnimationFrame job', function (done) {
      var ran = false;
      var j = new _Job["default"](function () {
        ran = true;
        done(new Error('job wasn\'t stopped'));
  ...
  describe('#idle', function () {
    ...
    test('should start job when it cannot request idle callback', function (done) {
      var backup = window.requestIdleCallback;
      window.requestIdleCallback = null;
      var j = new _Job["default"](done, 0);
      j.idle();
      jest.runAllTimers();
      window.requestIdleCallback = backup;
    });
  });
  describe('#startRaf', function () {
    test('should start job', function (done) {
      var j = new _Job["default"](done, 10);
      j.startRaf();
      jest.runAllTimers();
    ...
    test('should start job immediately when window is not defined', function (done) {
