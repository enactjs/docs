...
var VirtualListBasic = exports.VirtualListBasic = /*#__PURE__*/function (_Component) {
  function VirtualListBasic(_props) {
    ...
    _this.itemMarginLeft = null;
    _this.itemMarginRight = null;
    _this.itemMarginTop = null;
    _this.itemMarginBottom = null;
    _this.threshold = 0;
    ...
    _this.getItemPosition = function (index) {
      ...
      var offset = 0;
      var marginOffset = isPrimaryDirectionVertical ? _this.itemMarginTop + _this.itemMarginBottom : _this.itemMarginLeft + _this.itemMarginRight;
      if (stickTo === 'start') {
        // 'start'
        offset = optionalOffset;
      } else if (_this.props.itemSizes) {
        // 'end' for different item sizes
        offset = primary.clientSize - _this.props.itemSizes[index] - marginOffset - optionalOffset;
  ...
  return _createClass(VirtualListBasic, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var items = document.getElementsByClassName(_VirtualListModule["default"].listItem);
      if (!this.itemMarginTop && this.itemMarginTop !== 0 && items.length > 0) {
        var firstItemStyle = window.getComputedStyle(items[0].children[0]);
      ...
      if (prevProps.direction !== this.props.direction || prevProps.overhang !== this.props.overhang || prevProps.spacing !== this.props.spacing || !(0, _equals["default"])(prevProps.itemSize, this.props.itemSize) || !this.hasDataSizeChanged && !(0, _util.shallowEqual)(prevProps.itemSizes, this.props.itemSizes)) {
        ...
        if (this.scrollPosition === 0 && this.moreInfo.firstVisibleIndex !== 0) {
          ...
          this.setState({
            firstIndex: prevState.firstIndex
          });
          this.updateMoreInfo(this.props.dataSize, this.scrollPosition);
          for (var i = prevState.firstIndex; i < prevState.firstIndex + this.state.numOfItems; i++) {
            var _this$itemPositions, _this$prevItemPositio, _this$itemPositions2, _this$prevItemPositio2;
            var size = this.isPrimaryDirectionVertical ? clientHeight : clientWidth;
            if (((_this$itemPositions = this.itemPositions[i + 1]) === null || _this$itemPositions === void 0 ? void 0 : _this$itemPositions.position) > ((_this$prevItemPositio = this.prevItemPositions[i + 1]) === null || _this$prevItemPositio === void 0 ? void 0 : _this$prevItemPositio.position)) {
            ...
            if (((_this$itemPositions2 = this.itemPositions[i + 1]) === null || _this$itemPositions2 === void 0 ? void 0 : _this$itemPositions2.position) < ((_this$prevItemPositio2 = this.prevItemPositions[i + 1]) === null || _this$prevItemPositio2 === void 0 ? void 0 : _this$prevItemPositio2.position)) {
    ...
    value: function calculateMetrics(props) {
      ...
      for (var i = 0; i < this.itemPositions.length; i++) {
