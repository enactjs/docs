...
exports["default"] = exports.constants = exports.assignPropertiesOf = void 0;
exports.roundTarget = roundTarget;
exports.useScrollBase = exports.useScroll = void 0;
...
var constants = exports.constants = {
  ...
  minAnimationDuration = constants.minAnimationDuration,
...
function roundTarget(currentPosition, targetX, targetY) {
  var roundedTargetX, roundedTargetY;
  if (currentPosition !== null && currentPosition !== void 0 && currentPosition.scrollPos && _platform.platform.chrome > 120) {
    var _currentPosition$scro, _currentPosition$scro2;
    roundedTargetX = (currentPosition === null || currentPosition === void 0 || (_currentPosition$scro = currentPosition.scrollPos) === null || _currentPosition$scro === void 0 ? void 0 : _currentPosition$scro.left) < targetX ? Math.ceil(targetX) : Math.floor(targetX);
    roundedTargetY = (currentPosition === null || currentPosition === void 0 || (_currentPosition$scro2 = currentPosition.scrollPos) === null || _currentPosition$scro2 === void 0 ? void 0 : _currentPosition$scro2.top) < targetY ? Math.ceil(targetY) : Math.floor(targetY);
  } else {
    roundedTargetX = targetX;
    roundedTargetY = targetY;
  }
  return {
    roundedTargetX: roundedTargetX,
    roundedTargetY: roundedTargetY
  };
}
...
var useScrollBase = exports.useScrollBase = function useScrollBase(props) {
  ...
  var _useState5 = (0, _react.useState)(_resolution["default"].scale(1)),
    _useState6 = _slicedToArray(_useState5, 2),
    riRatio = _useState6[0],
    setRiRatio = _useState6[1];
  ...
  function handleResizeWindow() {
    ...
    if (_resolution["default"].scale(1) !== riRatio) {
      if (scrollContentProps.itemSize.minWidth && scrollContentProps.itemSize.minHeight) {
        scrollContentProps.itemSize.minWidth *= _resolution["default"].scale(1) / riRatio;
        scrollContentProps.itemSize.minHeight *= _resolution["default"].scale(1) / riRatio;
        setRiRatio(_resolution["default"].scale(1));
      }
    }
  ...
  function start(_ref2) {
    ...
    if (scrollMode === 'translate') {
      ...
      // scrollMode 'native'
      var _roundTarget = roundTarget(scrollContentHandle.current, targetX, targetY),
  ...
  function scrollAnimation(animationInfo) {
    return function (curTime) {
      ...
      var dynamicScrollDuration = function dynamicScrollDuration(target, source) {
        var customDuration = Math.max(minAnimationDuration, Math.abs(target - source));
      ...
      if (curTime < scrollAnimationDuration) {
        var toBeContinued = false,
          ...
          curTargetY = sourceY;
        if (canScrollHorizontally(bounds)) {
          var scrollDuration = dynamicScrollDuration(sourceX, targetX);
        ...
        if (canScrollVertically(bounds)) {
          var _scrollDuration = dynamicScrollDuration(sourceY, targetY);
          curTargetY = mutableRef.current.animator.timingFunction(sourceY, targetY, _scrollDuration, curTime, mutableRef.current.keyPressed);
  ...
  function addEventListeners() {
    ...
    (0, _utilEvent["default"])('keyup').addEventListener(scrollContainerRef, onKeyUp);
  ...
  function removeEventListeners() {
    ...
    (0, _utilEvent["default"])('keyup').removeEventListener(scrollContainerRef, onKeyUp);
