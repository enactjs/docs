...
var scenarios = {
  ...
  }, _container17.containerAttribute, 'positionTargetContainer'), "children", (0, _utils.join)((0, _utils.container)(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _container17.containerAttribute, 'child'), "id", 'spottableDefault'), "className", 'spottable-default'), "children", (0, _utils.join)((0, _utils.spottable)({
    id: 'firstChildSpottable'
  })))))))
};
...
describe('container', function () {
  ...
  describe('#getPositionTargetOnFocus', function () {
    ...
    test('should return a container that has positionTargetOnFocus configured', (0, _utils.testScenario)(scenarios.positionTargetOnFocusContainer, function (root) {
      (0, _container17.configureContainer)('positionTargetContainer', {
      ...
      var actual = (0, _container17.getPositionTargetOnFocus)(root.querySelector('#firstChildSpottable'));
      expect(actual).toEqual(expected);
    }));
  });
});