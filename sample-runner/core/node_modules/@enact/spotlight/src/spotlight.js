...
var Spotlight = exports.Spotlight = function () {
  ...
  */
  ...
  function focusElement(elem, containerIds, fromPointer, preventScroll) {
    ...
    var focusOptions = preventScroll || (0, _container.isWithinOverflowContainer)(elem, containerIds) ? {
      preventScroll: true
    } : null;
  ...
  var exports = /** @lends spotlight.Spotlight */{
    ...
    focus: function focus(elem) {
      ...
      if (!elem) {
        ...
        if ((0, _container.getContainerConfig)(elem)) {
          target = (0, _target.getTargetByContainer)(elem, options.enterTo);
          wasContainerId = true;
        ...
        target = (0, _target.getTargetByContainer)((0, _container.getContainerId)(elem), options.enterTo);
      ...
      if ((0, _container.isNavigable)(target, nextContainerId, true)) {
        var focused = focusElement(target, nextContainerIds, false, options.preventScroll);
     ...
     * @public
     */
    getPausedInstance: _Pause.getPausedInstance,
    /**
     ...
     * @private
     */
    resetKeyHoldState: function resetKeyHoldState() {
      SpotlightAccelerator.reset();
      _5WayKeyHold = false;
    }
  };
