 ...
 * @private
 */
var _getDeepSpottableDescendants = exports.getDeepSpottableDescendants = function getDeepSpottableDescendants(containerId, excludedContainers) {
  return getSpottableDescendants(containerId).map(function (n) {
    if (isContainer(n)) {
      ...
      if (excludedContainers && excludedContainers.indexOf(id) >= 0) {
        ...
        return _getDeepSpottableDescendants(id, excludedContainers);
      }
    }
    return [n];
...
function getContainerDefaultElement(containerId, preferredEnterTo) {
  ...
  var spottables = _getDeepSpottableDescendants(containerId);
...
function getContainerNavigableElements(containerId, preferredEnterTo) {
  ...
  if (!next) {
    ...
    _getDeepSpottableDescendants(containerId) : getSpottableDescendants(containerId);
...
function persistLastFocusedElement(containerId) {
  ...
  if (cfg) {
    ...
    if (lastFocusedElement) {
      var all = _getDeepSpottableDescendants(containerId, [], true);
