...
button:
  ...
  href: https://github.com/enactjs/docs/blob/develop/src/pages/docs/tutorials/tutorial-typescript/app-setup/index.md
---
...
- Complete the [Hello Enact](/tutorials/intro/hello-enact/) tutorial so you are ready to dive into the code
...
> **Note**: Before you begin this tutorial, make sure you have installed the Enact CLI tool.  See [Enact Development Setup](/tutorials/intro/setup/) for more information.
...
**Next: [TypeScript Overview](/tutorials/tutorial-typescript/typescriptoverview/)**
