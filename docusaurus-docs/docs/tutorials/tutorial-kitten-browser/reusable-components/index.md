...
Let's take this opportunity to introduce [arrow functions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions) ([spec](https://262.ecma-international.org/6.0/#sec-arrow-function-definitions)). Arrow functions are a more terse way to define functions in JavaScript that lexically bind the `this` value.
